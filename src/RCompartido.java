...
public class RCompartido {
    ...
    private boolean hilos[] = {false, false, false, false};     //Dekker
    private int turno;                                          //Dekker
    ...
    public boolean[] getHilos() {
        return hilos;
    }
    public void setHilos(int pos, boolean valor) {
        this.hilos[pos] = valor;
    }
